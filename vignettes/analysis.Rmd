...
for(i in seq_len(5)){ # 5 repetitions of 10-fold CV
  ...
  result[[i]] <- cv.multiple(y=y,X=x,family="gaussian",method=method,nfolds=10,alpha=1,alpha.init=alpha.init,type=type)
}
...
#test <- list()
#for(i in 1:5){
#  test[[i]] <- joinet:::cv.joinet(Y=Y,X=X,family="gaussian")
#}
